...
var _brochure = require('./api/products/brochure');
...
var _banners = require('./api/banners');

var _banners2 = _interopRequireDefault(_banners);

var _enquire = require('./api/enquire');
...
var Client = function Client() {
	...
	var webstoreClient = new _webstoreClient2.default({
	...
	this.products.brochure = new _brochure2.default(apiClient);
	...
	this.brands = new _brands2.default(apiClient);
	this.banners = new _banners2.default(apiClient);
	this.enquiry = new _enquire2.default(apiClient);
	this.contactus = new _contactus2.default(apiClient);
	...
	this.ajax.paymentFormSettings = new _ajaxPaymentFormSettings2.default(
		ajaxClient
	);
	this.ajax.pages = new _pages2.default(ajaxClient);
	this.ajax.brands = new _brands2.default(ajaxClient);
	this.ajax.banners = new _banners2.default(ajaxClient);
	this.ajax.enquiry = new _enquire2.default(ajaxClient);
	this.ajax.contactus = new _contactus2.default(ajaxClient);

	this.webstore = {};
	this.webstore.account = new _account2.default(webstoreClient);
	this.webstore.services = new _services2.default(webstoreClient);
	this.webstore.services.settings = new _serviceSettings2.default(
		webstoreClient
	);
...
Client.authorize = function(baseUrl, email, password) {
	return _apiClient2.default.authorize(baseUrl, email, password);
};
