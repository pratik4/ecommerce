...
var WebStoreClient = (function(_RestClient) {
	...
	function WebStoreClient(options) {
		...
		return _possibleConstructorReturn(
			this,
			(WebStoreClient.__proto__ || Object.getPrototypeOf(WebStoreClient)).call(
				this,
				{ baseUrl: 'https://api.cezerin.com/v1', token: options.token }
			)
		);
	}
...
WebStoreClient.authorize = function(email, adminUrl) {
	...
	return (0, _crossFetch2.default)(
		...
		config
	).then(_restClient2.default.returnStatusAndJson);
};
