...
export default (state = initialState, action) => {
	switch (action.type) {
		...
		case t.PRODUCT_BROCHURE_UPLOAD_END:
			return Object.assign({}, state, {
				uploadingBrochure: false
			});

		case t.PRODUCT_BROCHURE_UPLOAD_START:
			return Object.assign({}, state, {
				uploadingBrochure: true
			});

		case t.PRODUCT_BROCHURE_RECEIVE:
			return Object.assign({}, state, {
				editProductBrochure: action.brochure
			});
