...
const appReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case t.PRODUCTS_RECEIVE:
			if (action.products) {
				return Object.assign({}, state, {
					...
					productsCurrentPage: action.products.current_page,
					productsTotalPage: action.products.total_page,
		...
		case t.PRODUCT_ENQUIRY:
		case t.PRODUCT_ENQUIRY_REQUEST:
		case t.CONTACTUS_FORM_REQUEST:
		case t.CONTACTUS_FORM:
		default:
			return state;
	}
};
