	...
	render() {
		...
		return (
			<Fragment>
				...
				<section className="hero index-catalogue is-medium is-hidden-touch">
					<div className="hero-body">
						...
						<span className="catalogue-dropdown select">
							...
							>
								<option className="download-catalogue-text" value="choose">
									Choose Product Catalogue
								</option>
								<option
									className="download-catalogue-text"
									value="/assets/images/brochures/2015BusinessMachinesBrochure.pdf"
								>
									Business Machines Brochure
								</option>
								<option
									className="download-catalogue-text"
									value="/assets/images/brochures/CBT0756_Nobo_Prestige Brochure_2015_Eng.pdf"
								>
									Nobo Brochure
								</option>
								<option
									className="download-catalogue-text"
									value="/assets/images/brochures/CBT0757_Rexel_Quartet Brochure_uk.pdf"
								>
									Quartet Brochure
								</option>
								<option
									className="download-catalogue-text"
									value="/assets/images/brochures/K14_2243_Winter 2015 B2BCatalog_FINALEULowRez.pdf"
								>
									Kensington Brochure
								</option>
							</select>
