...
export default class CustomProducts extends React.Component {
	...
	fetchProducts = ({
		...
		const filter = {
			...
			sort,
			fields:
				'path,id,name,category_id,category_name,sku,images,enabled,featured,discontinued,stock_status,stock_quantity,price,on_sale,regular_price,attributes,tags',
			limit: limit || 4,
			offset: 0
		};
